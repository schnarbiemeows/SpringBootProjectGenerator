...
class PojoAndDtoGenerator:
    ...
    @staticmethod
    def create_field_ann(fielddata, file, src):
        """
        ...
        if src == "pojo":
            ...
            if (fielddata.primarytype != None and autogen_count == 0):
                file.write(tabs + Constants.ann_autogen + "\n")
                autogen_count +=1   # just in case there is a compound primary key, only the first field is autogenerated
        #else:
